...
static LogicalResult buildPerfSinkFunc(Location loc, const std::string& funcName,
                                       Operation *op,
                                       PatternRewriter &rewriter) {
...
static LogicalResult buildPerfRuntimeFunc(Location loc, const std::string& funcName,
                                          Operation *op,
                                          PatternRewriter &rewriter) {
